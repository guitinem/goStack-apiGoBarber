                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        availability = eachHourArray.map(function (hour) {
                            var hourAvailability = appointments.find(function (appointment) { return date_fns_1.getHours(appointment.date) === hour; });
                            var compareDate = new Date(year, month - 1, day, hour);
                            return {
                                hour: hour,
                                available: !hourAvailability && date_fns_1.isAfter(compareDate, currentDate),
                            };
                        });

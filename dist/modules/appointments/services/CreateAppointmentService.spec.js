...
var createAppointmentService;
describe('CreateAppointment', function () {
    beforeEach(function () {
        fakeAppointmentsRepository = new FakeAppointmentsRepository_1.default();
        createAppointmentService = new CreateAppointmentService_1.default(fakeAppointmentsRepository);
    });
    ...
    it('should not be able to create two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createAppointmentService.execute({
                            date: appointmentDate,
                            user_id: 'user-id',
                            provider_id: 'provider-id',
    ...
    it('should not be able to create an appointments on a past date', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should not be able to create an appointment with same user as provide', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {

...
var ListProviderMonthAvailabilityService = /** @class */ (function () {
    ...
    ListProviderMonthAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointments, numberOfDays, eachDayArray, availiability;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentsRepository.findAllInMonthFromProvider({ provider_id: provider_id, month: month, year: year })];
                    case 1:
                        appointments = _b.sent();
                        numberOfDays = date_fns_1.getDaysInMonth(new Date(year, month - 1));
                        eachDayArray = Array.from({
                            length: numberOfDays,
                        }, function (_, index) { return index + 1; });
                        availiability = eachDayArray.map(function (day) {

...
describe('ResetPassword', function () {
    beforeEach(function () {
        ...
        resetPasswordService = new ResetPasswordService_1.default(fakeUserRepository, fakeUserTokensRepository, fakeHashProvider);
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    expect(updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.password).toEqual('123123');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should not be able to reset the password with a non-exist token', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(resetPasswordService.execute({
    ...
    it('should not be able to reset the password with a non-exist user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserTokensRepository.generate('non-exist-user')];
                case 1:
                    token = (_a.sent()).token;
                    return [4 /*yield*/, expect(resetPasswordService.execute({
                            token: token,
                            password: 'randomPassword',
                        })).rejects.toBeInstanceOf(AppError_1.default)];
                case 2:
    ...
    it('should not be able to reset the password if passed more than two hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRepository.create({

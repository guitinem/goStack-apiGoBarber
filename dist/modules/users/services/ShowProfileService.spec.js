...
describe('ShowProfile', function () {
    ...
    it('should be able to show the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, showProfileService.execute({ user_id: user.id })];
                case 2:
                    profile = _a.sent();
    ...
    it('should not be able to show a non-existing profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(showProfileService.execute({ user_id: 'non-existing-user' })).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }

...
describe('UpdateAvatarUser', function () {
    ...
    it('should not be able to update an avatar from non exist user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    it('should delete old avatar when updating new one', function () { return __awaiter(void 0, void 0, void 0, function () {
        var deleteFileFunction, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    deleteFileFunction = jest.spyOn(fakeStorageProvider, 'deleteFile');

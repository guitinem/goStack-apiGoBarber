...
var ResetPasswordService = /** @class */ (function () {
    function ResetPasswordService(userRepository, userTokenRepository, hashProvider) {
    ...
    ResetPasswordService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userToken, user, createdDateToken, compareDate, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        userToken = _c.sent();
                        if (!userToken) {
                            throw new AppError_1.default('Users token does not exists');
                        }
                    ...
                    case 2:
                        ...
                        createdDateToken = userToken.created_at;
                        compareDate = date_fns_1.addHours(createdDateToken, 2);
                        if (date_fns_1.isAfter(Date.now(), compareDate)) {
                            throw new AppError_1.default('Expired token');
                        }
                        _b = user;

...
var sendForgotPasswordEmailService;
describe('SendForgotPasswordEmail', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmailService = new SendForgotPasswordEmailService_1.default(fakeUserRepository, fakeUserTokensRepository, fakeMailProvider);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sendEmail = jest.spyOn(fakeMailProvider, 'sendEmail');
                    fakeUserRepository.create({
                        name: 'Fulano Santos',
                        email: 'fulano.santos@gmail.com',
                        password: '123456oi',
                    });
                    return [4 /*yield*/, sendForgotPasswordEmailService.execute({
                            email: 'fulano.santos@gmail.com',
                        })];
                case 1:
                    _a.sent();
    ...
    it('should not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordEmailService.execute({
                        email: 'fulano.santos@gmail.com',
